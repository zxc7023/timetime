...
if($str)
{
  if(move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $file_path)){
    $result = mysqli_query($con, "UPDATE talent_buy_posting SET title='$title' , dayResult='$dayResult' , gender=(select gender from userjoin where userjoin.id='$id') , writeDate='$writeDate' , type='$type' , startHour='$startHour' , endHour='$endHour' , category='$category' , talent='$talent' , contents='$contents' , filePath='$file_path' WHERE boardNumber='$boardNumber'");
    echo "success";
  }
  else{
    echo "moveFail";
  ...
  $result = mysqli_query($con, "UPDATE talent_buy_posting SET title='$title' , dayResult='$dayResult' , gender=(select gender from userjoin where userjoin.id='$id') , writeDate='$writeDate' , type='$type' , startHour='$startHour' , endHour='$endHour' , category='$category' , talent='$talent' , contents='$contents' WHERE boardNumber='$boardNumber'");
    echo "success";
}
