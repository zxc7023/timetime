...
$res = mysqli_query($con, "SELECT talent_sale_posting.boardNumber,talent_sale_posting.id,talent_sale_posting.title,talent_sale_posting.dayResult,talent_sale_posting.gender,talent_sale_posting.writeDate,talent_sale_posting.type,talent_sale_posting.major,talent_sale_posting.subMajor,talent_sale_posting.startHour,talent_sale_posting.endHour,talent_sale_posting.category,talent_sale_posting.talent,talent_sale_posting.contents,talent_sale_posting.filePath, avg(review.score),(SELECT count(*) FROM review WHERE review.num=talent_sale_posting.boardNumber) FROM talent_sale_posting INNER JOIN review ON talent_sale_posting.boardNumber = review.num GROUP BY talent_sale_posting.boardNumber ORDER BY avg(review.score) DESC LIMIT 5");
