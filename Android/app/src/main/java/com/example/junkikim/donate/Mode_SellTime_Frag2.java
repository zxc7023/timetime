...
public class Mode_SellTime_Frag2 extends Fragment
{
    ...
    Mode_SellTime_Frag2_list modeSellTimeFrag2_list;
    String category;
    ...
    public void onClickedTalent(View v) {
        ...
        modeSellTimeFrag2_list = Mode_SellTime_Frag2_list.newInstance(category,talent);
        tr.remove(fragment);
        tr.replace(R.id.maincontainer1, modeSellTimeFrag2_list,"modeSellTimeFrag2_list");
