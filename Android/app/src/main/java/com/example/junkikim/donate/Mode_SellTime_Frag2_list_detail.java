    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.delect_board:
                String link = "http://1.243.135.179:8080/delete_talent_buy_posting.php/";
        ...
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                try {
                    ...
                    String link ="http://1.243.135.179:8080/get_review_buy.php/";
        ...
        class InsertReview extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                try {
                    ...
                    String link = "http://1.243.135.179:8080/insert_review_buy.php/";
